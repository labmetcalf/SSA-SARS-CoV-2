...
f.popn_specific_ifr.drr <- function(demo.age.str, ifr_shift = 0){
...
df.exps.drr <- df.plot %>% group_by(COUNTRY_CODE) %>%
...
df.exps.ifr <- df.plot %>% group_by(COUNTRY_CODE) %>%
