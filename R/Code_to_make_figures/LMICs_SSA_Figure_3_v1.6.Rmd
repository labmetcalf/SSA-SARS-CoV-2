...
#3
filename.iso_codes <- "iso_codes.csv"
iso_codes <- read.csv(file.path(mainDir, filename.iso_codes), stringsAsFactors = FALSE)
#4
filename.hosp_ests <- "hosp_from_salje.csv"
hosp_ests <- read.csv(file.path(mainDir, filename.hosp_ests), stringsAsFactors = FALSE)
#5
...
#6
filename.metadata <- "METADATA_2020_07_03_SSA_indicators.csv"
metadata <- read.csv(file.path(mainDir, filename.metadata), stringsAsFactors = FALSE)
```
...
ifr_cols <- c("ifr_by_age"       = "black", 
              "ifr_by_ageplus2"  = "darkgray", 
              "ifr_by_ageplus5"  = "darkgray", 
              "ifr_by_ageplus10" = "darkgray")
ifr_labs <- c("Baseline", 
              "Shifted (2y younger)", 
              "Shifted (5y younger)", 
              "Shifted (10y younger)")
...
- Cleaning up UN age data
  - **FIX** Tanzania and Tunisia are confused in the UN data
  - **FIX** Swaziland / Eswatini age data are missing
