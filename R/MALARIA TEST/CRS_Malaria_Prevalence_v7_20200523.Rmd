...
- Reference: Golden et al 2017. Cohort Profile: The Madagascar Health and Environmental Research (MAHERY) study in north-eastern Madagascar. International Journal of Epidemiology, Volume 46, Issue 6, December 2017, Pages 1747–1748d. [PMID: 29040632](https://pubmed.ncbi.nlm.nih.gov/29040632/)
...
- `function.make_dot_label`: Making labels to display HH infection outcomes
  ...
  - Outputs:
    - Returns a vector of character strings, e.g. `○○○●●●`
...
function.make_dot_label <- function(hh_ind_count_v, hh_rdt_pos_count_v){
  ...
  for(i in 1:length(hh_ind_count_v)){
    ...
    text_neg_i      <- paste(rep("○", hh_ind_count_v[i] - hh_rdt_pos_count_v[i]), collapse = "")
    text_pos_i      <- paste(rep("●", hh_rdt_pos_count_v[i]), collapse =  "")
